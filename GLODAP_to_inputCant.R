...
library(Imap)
library(lubridate)
source("C:/Users/MFontela/Nextcloud/UTILIDADES/Recetas gráficas/R/Fontela_theme.R")


setwd('C:/Users/MFontela/Nextcloud/Database/GLODAP') #ACTUALIZA
#lista los .mat
...
write.csv(A, file="input_data_GLODAP2.csv", row.names = F, sep=";") #El nombre del archivo es para que coincida con el que viene por defecto en el run_phi del Matlab
#El sep es para que separe por ; que es cómo están en el input_data.csv que queremos reproducir
#Fuck! a veces da problemas de comas-puntoscomas...
